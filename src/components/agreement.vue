<template>
	<div class="popup pop_xy" style="border:2px solid #cccccc;">
		<h2 class="my-title">算客工场服务协议</h2>

		<p>算客工场（以下简称“本网站”）依据《算客工场服务协议》（以下简称“本协议”）的规定提供服务，本协议具有合同效力。用户注册或登录时，请您认真阅读本协议，审阅并选择接受或不接受本协议。</p>
		<p>若您已经注册或登录为本网站用户，即表示您已充分阅读、理解并同意自己与本网站订立本协议，且您自愿接受本协议。为了给用户提供更好的服务，本网站会及时变更本协议并在本网站上予以公告。经修订的条款一经在本网站公布后，立即自动生效。如您不同意相关变更，请停止使用本网站。本协议内容包括协议正文及所有算客工场已经发布的各类规则。所有规则为本协议不可分割的一部分，与本协议正文具有同等法律效力。一旦您继续使用本网站，则表示您已接受并自愿遵守经修订后的条款。</p>
		<p>第一条 用户资格</p>
		<p>1、只有符合下列条件之一的自然人或法人才能申请成为本网站用户，可以使用本网站的服务：</p>
		<p>A、年满十八周岁，并具有民事权利能力和民事行为能力的自然人；　　</p>
		<p>B、无民事行为能力人或限制民事行为能力人应经过其监护人的同意；　　</p>
		<p>C、根据中国法律、法规、行政规章成立并合法存在的机关、企事业单位、社团组织和其他组织。无法人资格的单位或组织注册为本网站用户的，其与本网站之间的协议自始无效，本网站一经发现，有权立即终止对该用户的服务，并追究其使用本网站服务的一切法律责任。　　</p>
		<p>2、用户注册时需要提供明确的联系地址和联系电话，并提供真实姓名或名称。</p>
		<p>第二条 用户的权利和义务　</p>
		<p>1、用户有权根据本协议及本网站发布的相关规则，利用本网站发布需求信息、查询用户信息、参与需求投标，在本网站社区及相关产品发布信息，参加本网站的有关活动及有权享受本网站提供的其他有关资讯及信息服务；</p>
		<p>2、用户须自行保管自己的用户账号和密码，且须对在用户账号密码下发生的所有活动（包括但不限于发布需求信息、网上点击同意各类协议与规则、参与需求投标等）承担责任。用户有权根据需要自行更改登录账号和密码。因用户的过错导致的任何损失由用户自行承担，该过错包括但不限于：不按照交易提示操作，未及时进行交易操作，遗忘或泄漏密码，密码被他人破解，用户使用的计算机被他人侵入等；</p>
		<p>3、用户应当向本网站提供真实准确的注册信息，包括但不限于真实姓名、身份证号、联系电话、地址、邮政编码等。保证本网站可以通过上述联系方式与其进行联系。同时，用户也应当在相关资料实际变更时及时更新有关注册资料；</p>
		<p>4、用户不得以任何形式擅自转让或授权他人使用自己在本网站的用户帐号；</p>
		<p>5、用户有义务确保在本网站上发布的需求信息真实、准确，无误导性；　</p>
		<p>6、用户在本网站上发布需求和在社区内及相关产品发布信息，不得违反国家法律、法规、行政规章的规定、不得侵犯他人知识产权或其他合法权益的信息、不得违背社会公共利益或公共道德、不得违反算客工场的相关规定；</p>
		...
		<p>B、通过任何方式对本网站内部结构造成或可能造成不合理或不合比例的重大负荷的行为；</p>
		<p>C、通过任何方式干扰或试图干扰网站的正常工作或网站上进行的任何活动。</p>
		<p>15、用户有权在同意本网站相关规则的前提下享受雇主保障服务（包括但不限于诚信保证、15天质量维护）；　</p>
		<p>16、用户同意接收来自本网站的信息，包括但不限于活动信息、交易信息、促销信息等。</p>
		<p>第三条 算客工场的权利和义务　　</p>
		<p>1、本网站仅为用户提供一个信息交流平台，是需求方发布需求和服务方提供解决方案的一个交易市场，本网站对交易双方均不加以监视或控制，亦不介入交易的过程；本网站在用户注册时会对用户提供的信息（例如资质证书、用户姓名或名称等）进行形式审核，但是本网站对该信息的真实性、准确性无法做出实质判断，无法担保交易各方能够完整履行协议义务。本网站对用户间因交易而产生的法律关系及法律纠纷不承担责任。此外，与以欺诈手段行事的人进行交易的风险是客观存在的，用户在使用平台时应当小心谨慎并运用常识进行选择与判断。</p>
		...
		<p>5、用户因在本网站网上交易与其他用户产生纠纷的，用户将纠纷告知本网站，或本网站知悉纠纷情况的，经审核后，本网站有权通过电子邮件及电话向纠纷双方了解纠纷情况，并将所了解的情况互相通知对方；用户通过司法机关依照法定程序要求本网站提供相关资料，本网站将积极配合并提供有关资料；</p>
		<p>6、因网上信息平台的特殊性，本网站没有义务对所有用户的交易行为以及与交易有关的其他事项进行事先审查和实质审查，但如发生以下情形，本网站有权无需征得用户的同意限制用户的活动、向用户核实有关资料、发出警告通知、暂时中止或无限期中止及拒绝向该用户提供服务：</p>
		<p>A、用户违反本协议或纳入本协议的相关规则；　　</p>
		<p>B、存在其他用户或第三方通知本网站，认为某个用户或具体交易事项存在违法或不当行为，并提供相关证据，而本网站无法联系到该用户核证或验证该用户向本网站提供的任何资料；　　</p>
		<p>C、存在其他用户或第三方通知本网站，认为某个用户或具体交易事项存在违法或不当行为，并提供相关证据。本网站以普通非专业交易者的知识水平标准对相关内容进行判别，可以明显认为这些内容或行为可能对本网站用户或本网站造成财务损失或法律责任。</p>
		<p>7、根据国家法律、法规、行政规章规定、本协议的内容和本网站所掌握的事实依据，可以认定该用户存在违法或违反本协议行为以及在本网站交易平台上的其他不当行为，本网站有权无需征得用户的同意在本网站交易平台及所在网站上以网络发布形式公布该用户的违法行为，并有权随时作出删除相关信息、终止提供服务等处理；</p>
		<p>8、本网站依据本协议及相关规则，可以冻结、使用、先行赔付、退款、处置用户缴存并冻结在本网站账户内的资金。被封号的用户如果账户中有资金，在扣除用户不正当收入后，用户可申请提现；</p>
		...
		<p>4、基于以下原因而造成的利润、商誉、使用、资料损失或其它无形损失，本网站不承担任何直接、间接、附带、特别、衍生性或惩罚性赔偿（即使本网站已被告知赔偿的可能性）：</p>
		<p>A、本网站的使用或无法使用；</p>
		...
		<p>E、为提供用户所要求的产品和服务，而必须和第三方分享用户的个人或法人信息；</p>
		<p>F、其它本网站根据法律或者网站规定认为合适的披露。</p>
		<p>3、信息安全：</p>
		<p>A、在使用本网站服务进行网上交易时，请用户妥善保护自己的个人或法人信息，仅在必要的情形下向他人提供；</p>
		<p>B、如果用户发现自己的个人或法人信息泄密，尤其是用户账户或“支付账户管理”账户及密码发生泄露，请用户立即联络本网站客服，以便我们采取相应措施。</p>
		<p>第八条 不可抗力</p>
		...
		<p>2、用户因交易发生的纠纷，双方可协商解决也可根据双方约定的相关规则进行解决，也可请求本网站予以调解。用户请求本网站予以调解的，本网站有权决定是否参与争议的调解。本网站受理并调解您与其他用户因交易服务产生的纠纷时，有权单方面独立判断其他用户对您的举报及索偿是否成立，若判断索偿成立，则本网站有权划拨您已支付的定金或交纳的履约保证金以及账户余额进行相应偿付。本网站没有使用自用资金进行偿付的义务，但若进行了该等支付，您应及时赔偿本网站的全部损失，否则本网站有权通过前述方式抵减相应资金或权益，如仍无法弥补损失，则本网站保留继续追偿的权利。因本网站非司法机关，您完全理解并承认，本网站会对证据的鉴别能力及对纠纷的处理能力有限，受理交易纠纷完全是基于您之委托，不保证处理结果符合您的期望；具体调解规则按照用户与网站签署的相关规则执行。</p>
		<p>3、凡因本协议及其规则发生的所有纠纷，双方可协商解决，若协商不成的，双方同意提交北京市仲裁委员会按其仲裁规则进行仲裁。</p>
		<p>第十一条 完整协议</p>
		<p>本协议由本协议条款与《算客工场服务规则》等本网站公示的各项规则组成，相关名词可互相引用参照，如有不同理解，以本协议条款为准。</p>
		<p>您对本协议理解和认同，您即对本协议所有组成部分的内容理解并认同，一旦您使用本服务，您和本公司即受本协议所有组成部分的约束。</p>
		<p>第十二条 算客工场对本服务协议包括基于本服务协议制定的各项规则拥有最终解释权。</p>
		<p>第十三条 严正声明</p>
		<p>1、禁止转包承接的工程造价咨询业务。</p>
		<p>2、禁止借用/冒用他人资质开展工程咨询业务。</p>
		<p>4、在平台承接业务的算客需具备工程造价从业者资格证书。</p>
		<p>5、禁止接受不同雇主委托的同一工程项目的造价咨询业务。</p>
		<p>6、禁止以恶意压低收费等方式进行不正当竞争。</p>
		<p>7、禁止超越资质等级业务范围承接造价咨询业务。</p>
		<p>8、禁止对外提供工程造价服务过程中获知的当事人商业秘密和业务资料。</p>
		<p>9、企业行为应符合《工程造价咨询企业管理办法》的相关规定。</p>
		<p>10、严禁用户间利用本平台进行线下交易。</p>
		<p>11、遵从本网站争议处理相关规定。</p>
		<p>第十四条 附则</p>
		<p>在本协议中所使用的下列词语，除非另有定义，应具有以下含义：</p>
		<p>“本网站”在无特别说明的情况下，均指"算客工场"（http://www.3kgc.com）。</p>
		<p>“用户”：指满足本协议第一条用户资格的自然人及法人，包含雇主和算客。</p>
		<p>“雇主”：是指在本网站上进行发布需求或购买增值服务等“买”操作的用户。</p>
		<p>“算客”：是指在本网站上参加竞标、销售服务、出售技能等“卖”操作的用户。</p>
		<p></p>

		<div class="row">
			<a @click="close"><input type="button" class="button button-big button-fill button-danger" value="关闭"></a>
		</div>
	</div>
</template>
