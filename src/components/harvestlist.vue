            ...
            <ul
                ...
                <li v-for="item in list">
                    ...
                    <div class="ve-box-mcandt">
                        <div class="m_content">{{ item.desc }}</div>
                    </div>
                 <span class="ve-box-toptitle">
                        <img src="//img.qlylian.com/images/message.png">
                        <b>上传图纸及资料({{item.count_url}}):</b>
                    </span>
                    <div v-for="item2 in item.url"  class="ve-box-mcandt">
                        	<img src='item2.url' />
                    </div>
                    <div  class="ve-box-mcandt">
                    <div class="m_creattime">{{ item.addtime }}</div>
                    </div>
                </li>
            </ul>
    ...
    export default {
	  name: 'message',
		...
		methods: {
            ...
            getList () {
                axios.get(this.baseCont.PHP_API + '/user/harvestlist', {
                    params: {
