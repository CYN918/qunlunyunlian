<template>
    <div class="box">
        <mt-header title="新增工作经历">
            <router-link to="/resume" slot="left">
                <mt-button icon="back">返回</mt-button>
            </router-link>
        </mt-header>
        
        <mt-field class="ve-input-mt" label="公司名称:" placeholder="" type="text"  v-model="name" ></mt-field>
        ...
        <div id="select_service_type" style="padding: 0 15px;">
	        ...
	        <div class="options clearfix">
		        <div class="create_input" v-for="val in projectlist">
                    <input type="radio" :value="val.label" name="tes" :id="'tes' + val.value" v-model="project_site">
        ...
        <div id="select_service_type" style="padding: 0 15px;">
	        ...
	        <div class="options clearfix">
		        <div class="create_input" v-for="val in typelist">
                    <input type="radio" :value="val.label" name="box" :id="'box' + val.value" v-model="project_type">
        ...
        <mt-field label="主要业绩:" placeholder="" type="textarea" rows="4" v-model="work_content"></mt-field>
	...
	export default {
		...
		methods: {
			...
			refergo() {
				...
				axios.post(this.baseCont.PHP_API + '/user/workadd', {
                    company:this.name,
                    company_attr:this.project_site,
                    position:this.project_type,
                    start_time:this.startTime,
                    end_time:this.endTime,
                    desc:this.work_content
                })
                .then(response => {
