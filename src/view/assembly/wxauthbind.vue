<template>
    <div class="wxauthbind">
        <mt-header title="手机号绑定">
        </mt-header>
	  ...
	  name: 'wxauthbind',
		...
		methods: {
            refergo () {
                ...
                let wxobj  = JSON.parse(wxinfo);
                
                axios.post(this.baseCont.PHP_API + '/wxauthbind', {
                    phone: this.phone,
                    code: this.code,
                    openid: wxobj.openid,
            ...
            postphonecode () {
                ...
                axios.post(this.baseCont.PHP_API + '/wxauthsms', {
                    phone: this.phone,
                    code: this.encrypt,
                })
                .then(response => {
